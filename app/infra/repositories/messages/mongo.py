...
from infra.repositories.messages.converters import convert_chat_entity_to_document, convert_chat_document_to_entity, convert_message_to_document
...
class MongoDBMessagesRepository(BaseMessagesRepository, BaseMongoDBRepository):
    async def add_message(self, chat_uid: str, message: Message) -> None:
